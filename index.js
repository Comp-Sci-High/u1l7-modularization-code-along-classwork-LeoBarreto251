...
console.log(heroAction("The FLash","Super Speed", "Central City" ));
...
console.log(heroAction("The Flash","Super Speed", "Central City"))
console.log(heroAction("Superman","Kryptonian powers", "NYC"))
...
function villainAction (villain, location, chaos){
...
console.log(villainAction ("Kraven the Hunter","Bronx Zoo", "releasing and hunting wild animals" ))
...
// Step 2: Define a function with an appropriate name. 
function secretHero(secretIdentity, city, affiliation,archNemesis,catchphrase){
let newHero = {
...
console.log(secretHero("T' Chala", "Wakanda", "Avenger's", "Killmonger", "Wakanda Forever"))
console.log(secretHero("Bruce Wayne", "Gotham City", "Justice League", "The Joker", "I am vengeance, I am the night, I am Batman"))

// Step 6: Call the function for Iron Man
console.log(secretHero("Tony Stark", "NYC","Avenger's","The Mandarin", "I am Iron Man" ))
